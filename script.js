document.addEventListener('DOMContentLoaded', () => {
  ...
  toggleArabic: 'عربي',
  toggleEnglish: 'English',
  unitMetric: 'حوّل للإنجليزي (كوب، معلقة)',
  unitImperial: 'حوّل للمتري (جم، مل)',
  unitGrams: 'جرام (g)',
  unitCups: 'كوب (cups)',
  ...
  prepTechDesc_brownButter: `اسيبك من اللحمة، هنا التفاعل الجد! حمّر الزبدة لحد ما تاخد لون وريحة تخلي الكوكيز تقول يا سلام.
    <br>١. قطع الزبدة وحطها في حلة بلون فاتح.
    <br>٢. سيحها على نار متوسطة. هتعمل رغوة — عادي. قلّبها براحة.
    <br>٣. كمل تسخين. هتلاقي الرواسب بتتحمص وتبقى بني فاتح (ريحة بندق كده). الموضوع بياخد من ٥ لـ١٠ دقايق.
    <br>٤. أول ما تاخد لون، صبها في طبق مقاوم للحرارة بسرعة. ما تحرقهاش بقى.`,
  ...
  prepTechDesc_chillButterClassicThick: `ليه بنبرد؟ الزبدة وهي سايحة مش هتخفق كويس. لازم نرجّع الهيكل بتاعها.
    <br>١. ابردها ٥-١٠ دقايق.
    <br>٢. حطها في التلاجة لحد ما تبقى شبه عجينة لعب الأطفال — مش جامدة خالص. استهدف حوالي ١٦-١٨° مئوية.`,

  prepTechTitle_chillButterThin: 'تبريد مختلف للكريسبيز ❄️',
  prepTechDesc_chillButterThin: `لو بتعمل الكوكيز الرفايعة، برد الزبدة بس سيبها لينة كده.
    <br>١. خلى الزبدة ترجع لدرجة حرارة الغرفة، وبعدين حطها شوية في التلاجة (٣٠-٦٠ دقيقة). المفروض تبقى شادة شوية بس تتقطع بسهولة.`,

  prepTechTitle_toastMilkPowder: 'طعم زيادة: حمّص لبن البودرة 🔥',
  prepTechDesc_toastMilkPowder: `بيزود النكهة بتاعة التوفي/الكراميل. خصوصًا في الكوكيز السميكة.
    <br>١. افرد بودرة اللبن على صينية أو طاسة.
    <br>٢. في الفرن: ١٢٠°م لمدة ١٠-١٥ دقيقة (قلّب كل شوية). في طاسة: نار هادية وقلب دايمًا.
    <br>٣. خليك صاحي! أول ما يبقى لونه دهبي وريحتك تقول الله، طفي.`,
